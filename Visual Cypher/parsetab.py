...
_lr_productions = [
  ...
  ('function -> FUNCTION type ID add_function_id OP_LPAREN parameters OP_RPAREN bloque function','function',9,'p_function','vcparser.py',40),
  ('function -> FUNCTION VOID ID add_function_id OP_LPAREN parameters OP_RPAREN bloque function','function',9,'p_function','vcparser.py',41),
  ('function -> epsilon','function',1,'p_function','vcparser.py',42),
  ('add_function_id -> epsilon','add_function_id',1,'p_add_function_id','vcparser.py',46),
  ('main_function -> MAIN add_function_id OP_LPAREN OP_RPAREN bloque','main_function',5,'p_main_function','vcparser.py',51),
