...
cuboSemantico = [['int','int','+','int'],['int','int','-','int'],['int','int','*','int'],['int','int','/','int'],['int','int','and','error'], ['int','int','or','error'], ['int','int','<','boolean'], ['int','int','>','boolean'], ['int','int','<=','boolean'], ['int','int','>=','boolean'], ['int','int','==','boolean'], ['int','int','!=','error'],
                 ['int','float','+','int'],['int','float','-','int'],['int','float','*','float'],['int','float','/','int'],['int','float','and','error'], ['int','float','or','error'],  ['int','float','<','error'], ['int','float','>','error'], ['int','float','<=','error'], ['int','float','>=','error'], ['int','float','==','error'], ['int','float','!=','error'],
                 ...
                 ['float','int','+','float'], ['float','int','-','float'], ['float','int','*','float'], ['float','int','/','int'], ['float','int','and','error'], ['float','int','or','error'], ['float','int','<','error'], ['float','int','>','error'], ['float','int','<=','error'], ['float','int','>=','error'], ['float','int','==','error'], ['float','int','!=','error'],
